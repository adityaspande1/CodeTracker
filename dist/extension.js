...
const githubAuthCommand_1 = __webpack_require__(6);
const workSpaceTrackerService_1 = __webpack_require__(7);
const pushLog_1 = __webpack_require__(8); // Import pushLogToGitHub
...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('codetracker.pushLogToGitHub', async () => {
        ...
        try {
            await (0, pushLog_1.pushLogToGitHub)(logContent, accessToken, session);
        }
        catch (error) {
...
async function pushLogToGitHub(logContent, accessToken, session) {
    ...
    try {
        ...
        const fileResponse = await axios_1.default.get(apiUrl, {
            headers: {
        ...
        const treeResponse = await axios_1.default.post(treeApiUrl, {
            tree: [
                {
                    path: `logs/${fileName}`,
        ...
        const commitResponse = await axios_1.default.post(commitApiUrl, {
        ...
        await axios_1.default.patch(refApiUrl, {
        ...
        if (err.response && err.response.status === 404) {
            const createResponse = await axios_1.default.put(apiUrl, {
